...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "enter your STANY-TECH XMD session id here",
 
PREFIX: process.env.PREFIX || ".",
// Enter Your Desired Prefix

BOT_NAME: process.env.BOT_NAME || "『 STANY-TECH-XMD』",
// Enter Your Bot Name
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "255756738502",
// Set Owner Name

OWNER_NAME: process.env.OWNER_NAME || "ᴍʀ ꜰʀᴀɴᴋ ᴏꜰᴄ",
// Set Footer

DESCRIPTION: process.env.DESCRIPTION || "*© Gᴇɴᴇʀᴀᴛᴇᴅ ʙʏ STANY-TECH™*",
// add bot owner name   
 
ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/YkJyMRb/mrfrankofc.jpg",
// add img for alive msg

LIVE_MSG: process.env.LIVE_MSG || "> [🎐] STANY-TECH-XMD ɪs ᴏɴʟɪɴᴇ*⚡",
// add alive msg here 
...
AUTO_STATUS_MSG: process.env.AUTO_STATUS__MSG || "*[❄️] Hi there, STANY-TECH-XMD viewed your Status🎐*",
